...
export default function DiseaseInfo({ diseaseName, crop }: DiseaseInfoProps) {
  ...
  return (
    <div className="mt-6 rounded-2xl border border-field-soil/10 bg-white p-5 shadow-sm sm:p-8">
      ...
      {/* Disclaimer */}
      <div className="mt-6 rounded-xl border border-field-straw/40 bg-field-wheat/25 p-5">
